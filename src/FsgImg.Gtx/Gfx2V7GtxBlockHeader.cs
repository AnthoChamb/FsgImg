...
{
    public class Gfx2V7GtxBlockHeader : IGtxBlockHeader
    {
        public uint Magic { get; set; } = GtxConstants.GtxBlockHeaderMagic;
        public uint Size { get; set; } = GtxConstants.GtxBlockHeaderSize;
        public uint MajorVersion { get; set; } = GtxConstants.Gfx2V7GtxBlockMajorVersion;
        public uint MinorVersion { get; set; } = GtxConstants.Gfx2V7GtxBlockMinorVersion;
        public Gfx2V7GtxBlockType BlockType { get; set; }
        ...
        GtxBlockType IGtxBlockHeader.BlockType
        {
            ...
            set
            {
                BlockType = (Gfx2V7GtxBlockType)value;
            }
        }
    }
}
